    ...
    public PanelMultiActions(String s, Controleur c)
    {
        ...
        for (String s2 : s.split("\n"))
        {
            if (s2.contains("lettre"))
                ...
                this.add(new JLabel(new ImageIcon(new ImageIcon("./images/"+s2.substring(s2.indexOf("à")-2)+".png").getImage().getScaledInstance((int)(178*c.getRatio()), (int)(178*c.getRatio()), Image.SCALE_DEFAULT))));
